...
namespace Box2DSharp.Collision.Shapes
{
    ...
    public class ChainShape : Shape
    {
        ...
        {
            var clone = new ChainShape {Vertices = new FVector2[Vertices.Length]};
        ...
        public void CreateLoop(FVector2[] vertices, int count = -1)
        {
            ...
            for (var i = 1; i < count; ++i)
            {
                ...
                Debug.Assert(FVector2.DistanceSquared(v1, v2) > Settings.LinearSlop * Settings.LinearSlop);
            }
        ...
        public void CreateChain(FVector2[] vertices, int count, FVector2 prevVertex, FVector2 nextVertex)
        {
            ...
            for (var i = 1; i < count; ++i)
            {
                // If the code crashes here, it means your vertices are too close together.
                Debug.Assert(
                    FVector2.DistanceSquared(vertices[i - 1], vertices[i])
