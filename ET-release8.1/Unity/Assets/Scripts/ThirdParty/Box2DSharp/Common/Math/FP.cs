...
namespace TrueSync
{
    ...
    public partial struct FP : IEquatable<FP>, IComparable<FP>
    {
        ...
        {
            return left._serializedValue > righ._serializedValue ? righ : left;
        }
        
        public static FP Max(FP left, FP righ)
        {
            return left._serializedValue > righ._serializedValue ? left : righ;
        }
        ...
        public FP SlowMul(in FP x, in FP y)
        {
        ...
        public FP SlowAdd(in FP x, in FP y)
        {
